...
{
    private const string SessionId = "970f4a";
    // Debug mode requires writing to this exact workspace log file.
    private const string WorkspaceLogPath = @"D:\Github\ATP2\DSH NEWS\debug-970f4a.log";
    private static readonly string BuildLocalLogPath = Path.GetFullPath(Path.Combine(Application.dataPath, "..", "debug-970f4a.log"));
